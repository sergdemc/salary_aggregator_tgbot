...
output1 = {'dataset': [5906586, 5515874, 5889803, 6092634],
           'labels': ['2022-09-01T00:00:00', '2022-10-01T00:00:00', '2022-11-01T00:00:00', '2022-12-01T00:00:00']}

output2 = {'dataset': [0, 0, 0, 195028, 190610, 193448, 203057, 208605, 191361, 186224, 181561, 195264, 213854, 194070,
...
def test_aggregate_salaries_by_month():
    result1 = aggregate_salaries(input1['dt_from'], input1['dt_upto'], input1['group_type'])
    assert result1 == output1


def test_aggregate_salaries_by_day():
    result2 = aggregate_salaries(input2['dt_from'], input2['dt_upto'], input2['group_type'])
    assert result2 == output2


def test_aggregate_salaries_by_hour():
    result3 = aggregate_salaries(input3['dt_from'], input3['dt_upto'], input3['group_type'])
